  ...
  try {
    ...
    const adminHtml = `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:32px;background:#f9f9fb;border-radius:12px;">
        <div style="background:linear-gradient(135deg,#3F0C91,#700CEB);padding:28px 32px;border-radius:10px;margin-bottom:28px;">
          ...
          <p style="color:rgba(255,255,255,0.65);margin:6px 0 0;font-size:13px;">Via kemchutahomesltd.com — ${branch || "General"} enquiry</p>
        </div>
        ...
        <div style="margin-top:20px;padding:16px 20px;background:rgba(112,12,235,0.05);border-radius:10px;border-left:3px solid #700CEB;">
          ...
          <p style="margin:0;font-size:15px;color:#262626;line-height:1.75;">${message}</p>
        </div>
    ...
    const clientHtml = `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:32px;background:#f9f9fb;border-radius:12px;">
        ...
        <h2 style="font-size:20px;font-weight:800;color:#0f0a1e;margin-top:0;">Hi ${name}, we got your message! 👋</h2>
        <p style="color:#525252;font-size:15px;line-height:1.75;">
          ...
          <strong>"${subject}"</strong> and our team will get back to you within <strong>24 hours</strong>.
        </p>
    ...
    await Promise.allSettled([
      sendEmail({
        to: ADMIN_EMAIL(),
        subject: `Contact Enquiry: ${subject} — ${name} (${branch || "General"})`,
        html: adminHtml,
      }),
      sendEmail({
        to: email.trim(),
